...
import com.example.android.a7minutesworkout.databinding.ActivityExerciseBinding
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.example.android.a7minutesworkout/" + R.raw.press_start)
